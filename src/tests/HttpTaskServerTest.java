...
public class HttpTaskServerTest {
    ...
    @Test
    public void checkGetByIds() throws IOException, InterruptedException, URISyntaxException {
    ...
    //Андрей, привет! Не успел все тесты написать, а отправить надо позарез или в другую когорту.
    //В течение дня постараюсь прислать версию со всеми тестами. Спасибо за понимание!
}
